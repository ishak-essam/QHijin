...
namespace QHijin.Migrations
{
    ...
    [Migration("20240304101758_GenerateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEndHagan.Entities.Admin", b =>
                {
                    ...
                    b.HasKey("EmpId")
                        .HasName("PK__Admin__E1C7EEED86D5AABA");

                    b.HasIndex(new[] { "EmpId" }, "UQ__Admin__AFB3EC6C0CBA2A3A")
                        .IsUnique();
            ...
            modelBuilder.Entity("BackEndHagan.Entities.Admin", b =>
                {
                    b.HasOne("BackEndHagan.Entities.Employee", "Emp")
                        .WithOne()
                        .HasForeignKey("BackEndHagan.Entities.Admin", "EmpId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK__Admin__empID__5FB337D6");
            ...
            modelBuilder.Entity("BackEndHagan.Entities.Item", b =>
                {
                    b.HasOne("BackEndHagan.Entities.Bidding", "BiddingNoNavigation")
                        .WithMany("Items")
                        .HasForeignKey("BiddingNo")
                        .HasConstraintName("FK__Items__biddingNo__36B12243");
            ...
            modelBuilder.Entity("BackEndHagan.Entities.Title", b =>
                {
                    b.HasOne("BackEndHagan.Entities.Employee", null)
                        .WithMany("Titles")

...
namespace QHijin.Migrations
{
    ...
    [Migration("20240404145254_ItemPh")]
    partial class ItemPh
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEndHagan.Entities.Item", b =>
                {
                    b.HasOne("QHijin.Entities.ItemPhysical", "ItemPhysical")
                        .WithOne("Item")
                        .HasForeignKey("BackEndHagan.Entities.Item", "ItemPhysicalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

...
namespace QHijin.Migrations
{
    ...
    [Migration("20240423110456_VatServiceTrainerIdPay")]
    partial class VatServiceTrainerIdPay
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QHijin.Entities.AboutPhotos", b =>
                {
                    b.Property<int>("AbPhId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AbPhId"));
            ...
            modelBuilder.Entity("QHijin.Entities.Action", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QHijin.Entities.Ads", b =>
                {
                    b.Property<int>("AdId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AdsImgLocalPath")
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("AdsImgLocalPath");

                    b.Property<string>("AdsImgUrl")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("AdId")
                        .HasName("PK__AdIdAnd__46655E2E38A279F4");
            ...
            modelBuilder.Entity("QHijin.Entities.Advantages", b =>
                {
            ...
            modelBuilder.Entity("QHijin.Entities.ContactUs", b =>
                {
            ...
            modelBuilder.Entity("QHijin.Entities.Contracting_Policy", b =>
                {
                    b.Property<int>("con_pNo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("con_pNo");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("con_pNo"));
                    ...
                    b.ToTable("Contracting_Policy", (string)null);
                });

            modelBuilder.Entity("QHijin.Entities.Delivery_Period", b =>
                {
                    b.Property<int>("d_pN")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("d_pN"));
                    ...
                    b.ToTable("Delivery_Period", (string)null);
                });

            modelBuilder.Entity("QHijin.Entities.Feedback", b =>
                {
                    b.Property<int>("FBId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QHijin.Entities.HowTobuy", b =>
                {
                    b.Property<int>("HowBuyN")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("HowBuyN");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HowBuyN"));
                    ...
                    b.ToTable("HowTobuy", (string)null);
                });

            modelBuilder.Entity("QHijin.Entities.ItemPhysical", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ItemPhysical");
                });

            modelBuilder.Entity("QHijin.Entities.PaymentRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("QHijin.Entities.Policy_Refund", b =>
                {
                    b.Property<int>("p_refN")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("p_refN");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("p_refN"));
                    ...
                    b.ToTable("Policy_Refund", (string)null);
                });

            modelBuilder.Entity("QHijin.Entities.ServicesSite", b =>
                {
                    ...
                    b.ToTable("ServicesSite", (string)null);
                });

            modelBuilder.Entity("QHijin.Entities.Trainers", b =>
                {
                    ...
                    b.Property<double>("rentmoney")
                        .HasColumnType("float");

                    b.Property<string>("rpayment_link")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("trnCV")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("trnImgLocalPath")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("trnImgUrl")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("QHijin.Entities.AboutPhotos", b =>
                {
                    b.HasOne("BackEndHagan.Entities.About", "About")
                        .WithMany("AboutPhoto")
            ...
            modelBuilder.Entity("QHijin.Entities.Action", b =>
                {
                    b.HasOne("BackEndHagan.Entities.Type", "Type")
                        .WithMany("Actions")
            ...
            modelBuilder.Entity("QHijin.Entities.ItemPhysical", b =>
                {
                    b.HasOne("BackEndHagan.Entities.Item", "Item")
                        .WithOne("ItemPhysical")
                        .HasForeignKey("QHijin.Entities.ItemPhysical", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("QHijin.Entities.PaymentRequest", b =>
                {
                    ...
                    b.HasOne("QHijin.Entities.Trainers", "Trainer")
                        .WithMany("PaymentRequest")
            ...
            modelBuilder.Entity("QHijin.Entities.Trainers", b =>
                {
                    b.HasOne("BackEndHagan.Entities.Employee", "Employee")
                        .WithMany("Trainers")
                        .HasForeignKey("empId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("BackEndHagan.Entities.Employee", b =>
                {
                    ...
                    b.Navigation("Contracting_Policy");

                    b.Navigation("Delivery_Period");

                    b.Navigation("EmployeeItems");

                    b.Navigation("HowTobuy");

                    b.Navigation("Policy_Refund");
